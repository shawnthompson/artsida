...
<?php include('header.php'); ?>
		...
		<div class="cell">
			...
			<div class="col-sm-5 col-md-6 purple responsive"><p class="tag">Two round trip WestJet flights to North America/Europe to raffle!</p><img src="img/pic4.jpg" class="hidden-xs bottom-right photoh" alt=""></div>
